...
<html>
    ...
    <body>
        <div class="form-content">
            ...
            <input class="form-input-radio" type="radio" name="ugender" value="Male">Male
            <span class="gender-Female"><input class="form-input-radio" type="radio" name="ugender" value="Female">Female</span>
